						...
						<CommandGroup heading="Sub Accounts ">
							{!!user.Agency?.SubAccount.length ? (
								user.Agency.SubAccount.map((subaccount: SubAccount) => (
									<CommandItem
										key={subaccount.id}
										className="h-32 dark:!bg-background text-black dark:text-primary border-[1px] border-border p-4 rounded-lg dark:hover:!bg-background cursor-pointer transition-all mt-2"
									>
										<Link

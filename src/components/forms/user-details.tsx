"use client";
import {
	AuthUserWithAgencySidebarOptionsAndSubAccounts,
...
const UserDetails = ({ id, type, subAccounts, userData }: Props) => {
	...
	const [authUserData, setAuthUserData] =
		useState<AuthUserWithAgencySidebarOptionsAndSubAccounts | null>(null);
	...
	const onSubmit = async (values: z.infer<typeof userDataSchema>) => {
		...
		} else console.log("Error could not submit");
	};
